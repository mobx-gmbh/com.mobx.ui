...
namespace MobX.UI
{
    ...
    public partial class UIAsset : ScriptableAsset, IUIElement
    {
        #region Properties
        ...
        [ReadOnly]
        public bool IsOrWillOpen => IsLoaded && _uiInstance.IsOrWillOpen;

        [ReadOnly]
        public bool IsOrWillClose => !IsLoaded || _uiInstance.IsOrWillClose;
        ...
        public bool ConsumeBackPressed()
        {
            if (IsLoaded)
            {
                return _uiInstance.ConsumeBackPressed();
            }
            return false;
        }
